...
from service.ragfusion.core.vector.retrievers import BaseRetriever
...
class VectorStore(ABC):
    ...
    def _euclidean_relevance_score_fn(distance: float) -> float:
        ...
        # - the scale of your embedding (OpenAI's are unit normed. Many
        #  others are not!)
        # - embedding dimensionality
        # - etc.
        # This function converts the euclidean norm of normalized embedding
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        may differ depending on a few things, including:
        - the distance / similarity metric used by the VectorStore
        - the scale of your embedding (OpenAI's are unit normed. Many others are not!)
        - embedding dimensionality
        - etc.
