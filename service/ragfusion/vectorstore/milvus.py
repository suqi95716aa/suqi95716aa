...
from service.ragfusion.core.vector.vectorstores import VectorStore
...
class Milvus(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        self.priority_alias = priority_alias
    ...
    def _create_connection_alias(self, connection_args: dict) -> str:
        ...
        alias = uuid4().hex if not self.priority_alias else self.priority_alias
    ...
    def _extract_fields(self) -> None:
        ...
        self.fields = []    # clean every initial
    ...
    def switch_collection(self, col_name: str, kwargs):
        """
        Switch collection

        Args:
            col_name (str): collection name. (necessary)
        """
